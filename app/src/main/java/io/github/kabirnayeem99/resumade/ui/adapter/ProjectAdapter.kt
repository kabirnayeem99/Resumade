...
class ProjectAdapter(
    val onSaveButtonClick: (Project) -> Unit,
    val onDeleteButtonClick: (Project) -> Unit,
    val onEditButtonClick: (Project) -> Unit
    ...
    inner class ProjectViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val projectNameWrapper: TextInputLayout =
            itemView.findViewById(R.id.projectNameWrapper)
        private val projectName: TextInputEditText = itemView.findViewById(R.id.projectName)
        private val projectRoleWrapper: TextInputLayout =
            itemView.findViewById(R.id.projectRoleWrapper)
        private val projectRole: TextInputEditText = itemView.findViewById(R.id.projectRole)
        private val projectLinkWrapper: TextInputLayout =
            itemView.findViewById(R.id.projectLinkWrapper)
        private val projectLink: TextInputEditText = itemView.findViewById(R.id.projectLink)
        private val projectDescriptionWrapper: TextInputLayout =
            itemView.findViewById(R.id.projectDescriptionWrapper)
        private val projectDescription: TextInputEditText =
            itemView.findViewById(R.id.projectDescription)
                ...
                setOnClickListener {
                    if (mProject.saved) {
                        ...
                        val tempProjectLink = this@ProjectViewHolder.projectLink.text?.toString()
                            ?: ""
                        val tempProjectDescription =
                            this@ProjectViewHolder.projectDescription.text?.toString()
                                ?: ""
                        ...
                        if (tempProjectDescription.trim().isEmpty()) {
                            projectDescriptionWrapper.error =
